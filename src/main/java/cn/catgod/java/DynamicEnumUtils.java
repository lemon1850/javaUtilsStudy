...
////        System.out.println(JSON.toJSONString(Car.values()));
//        addEnum(Car.class, "WUdi", new Class<?>[]{int.class, String.class},
//                new Object[]{3, "wuddi"});
////        System.out.println(JSON.toJSONString(Car.values()));
//        for (Car businessType : Car.values()) {
//            if (businessType.getId() == 4 ){
